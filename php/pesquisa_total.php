    ...
    <div class="container">
        ...
        <?php
            ...
            if($cont>0){            
                ...
                while (($linha = $produtos->fetch(PDO::FETCH_ASSOC))!== false) {          
                    $return.= '<tr>';
               ...
               echo "<li><a class='btn ' href='pesquisa_total.php?pagina=1'><<</a> </li>";
                //exibe a paginação 
                for($i = 1; $i < $numPaginas + 1; $i++) { 
                    echo "<li><a class='btn ' href='pesquisa_total.php?pagina=$i'>".$i."</a> </li> "; 
                } 
                echo "<li><a class='btn ' href='pesquisa_total.php?pagina=$numPaginas'>>></a> </li>";
                echo "</ul></center>";
